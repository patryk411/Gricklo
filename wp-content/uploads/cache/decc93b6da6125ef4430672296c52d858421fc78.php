...
<nav class="navbar navbar-expand-lg w-100 position-absolute">
    ...
    <div class="container">
        <div class="section-baner__single-post__content col-lg-11 col-xl-9">
            <div class="section-baner__single-post__content__text">
                <h1 class="section-baner__single-post__content__text--heading"><?php echo the_title(); ?></h1>
            </div>
        </div>
    </div>
            ...
            <div class="row m-0 p-0">
                ...
                <div class="single-section__content__blog-post col-lg-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><?php echo the_field('post_title'); ?></a></h5>
                            ...
                            <div class="card-text"><?php echo the_field('post_text'); ?></div>
